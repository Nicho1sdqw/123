...
%% Step1：读取数据文件
filpath = './data/';
file_name = 'point_filtered_mono3-2';
...
I = binaryImg;
[centers1,radii1] = imfindcircles(binaryImg,[2 8],'ObjectPolarity','dark','Sensitivity',0.6, 'Method','TwoStage');
%可视化
figure(1)
imshow(I)

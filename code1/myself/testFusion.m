...
close all
dcenter = [];
file_name = 'point_filter_stereo3';
%文件读取2d信息
ab = load('./result_mat/point_filter_stereo3_2d.mat');
pcloud = ab.pcloud;
Location = pcloud.Location;
XYZ_World = ab.XYZ_World;
%文件读取3d信息
ac = load('./result_mat/point_filter_stereo3_3d.mat');
xy2 = ac.xy2;
X = ac.X;
figure;
...
for i  = 1:4
    ...
    Par = CircleFitLevenbergMarquardt(DataX,ParIni,0.3);
